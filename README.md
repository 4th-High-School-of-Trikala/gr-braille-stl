...
# Known issues / limitations - Γνωστά προβλήματα / περιορισμοί

- Το πρόγραμμα δέχεται ένα περιορισμένο εύρος χαρακτήρων, ελληνικών κυρίως.
- Πιθανόν να υπάρχει προβλήματα με τα dependencies σε πιο πρόσφατες εκδόσεις της Python. Στην μηχανή μου (Debian 12) τρέχει μια χαρά με την Python 3.11.2.
- Το πρόγραμμα μπορεί να πάρει μερικά λεπτά μέχρι να ολοκληρώσει την εργασία του και τα STL αρχεία που παράγονται μπορεί να είναι αρκετά δεκάδες megabyte σε μέγεθος.
